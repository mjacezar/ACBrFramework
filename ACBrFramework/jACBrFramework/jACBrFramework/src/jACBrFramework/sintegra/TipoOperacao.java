...
public enum TipoOperacao {
     ...
     * @return 
     */
    public static TipoOperacao valueOf(int pCodigo) {
        for (TipoOperacao lTipoOperacao : values()) {
            if (Integer.parseInt(lTipoOperacao.getCodigo()) == pCodigo) return lTipoOperacao;
        }
        return null;
    }   
    // </editor-fold>    
