...
/**
 * Classe que encapsula as funções de comunicação com o ECF; Esta classe utiliza
 * chamadas nativas ao componente ACBr32
 *
...
public final class ACBrECF extends ACBrClass
{
	...
	/**
	 * Aloca memória para o componente ACBr nativo e retorna handle do
	...
	/**
	 * Retorna o caminho do arquivo de logs dos comandos enviados e
	 * recebidos pelo ECF.
	 *
	...
	/**
	 * Define o caminho do arquivo de logs dos comandos enviados e recebidos
	 * pelo ECF.
	 *
	 ...
	 *
	 * @param aguardaImpressao True caso o componente deva aguardar; False
	 * caso contrário.
	 * @throws ACBrException
	 */
	...
	/**
	 * Retorna o total de cancelamentos sobre ISSQN (Imposto Sobre Serviços
	 * de Qualquer Natureza) registrado no ECF.
	 *
	...
	/**
	 * Retorna o total de descontos sobre ISSQN (Imposto Sobre Serviços de
	 * Qualquer Natureza) registrado no ECF.
	 *
	...
	/**
	 * Retorna o total de acréscimos sobre ISSQN (Imposto Sobre Serviços de
	 * Qualquer Natureza) registrado no ECF.
	 *
	...
	/**
	 * Retorna o total de substituição tributária sobre ISSQN (Imposto Sobre
	 * Serviços de Qualquer Natureza) registrado no ECF.
	 *
	 * @return Double contendo o total de substituição tributária sobre
	 * ISSQN.
	 * @throws ACBrException
	 */
	...
	/**
	 * Retorna o total não tributado sobre ISSQN (Imposto Sobre Serviços de
	 * Qualquer Natureza) registrado no ECF.
	 *
	...
	/**
	 * Retorna o total de isenção sobre ISSQN (Imposto Sobre Serviços de
	 * Qualquer Natureza) registrado no ECF.
	 *
	 ...
	 *
	 * @return True caso o ECF esteja em horário de verão; False caso
	 * contrário.
	 * @throws ACBrException
	 */
	...
	/**
	 * Verifica se o ECF é capaz de identificar o consumidor no rodapé do
	 * ECF.
	 *
	...
	/**
	 * Retorna o intervalo a agurardar após o envio de um comando ao ECF (em
	 * milissegundos).
	 *
	 * @return Intervalo
	 * @throws ACBrException
	...
	/**
	 * Define o intervalo a aguardar após o envio de um comando ao ECF (em
	 * milissegundos).
	 *
	 * @param intervalo
	 * @throws ACBrException
	...
	/**
	 * Identifica o consumidor para o Cupom atual.<br/> Utilize a
	 * propriedade getIdentificaConsumidorRodape para verificar se este
	 * método deve ser chamado antes ou depois de abrir um novo cupom.
	 *
	 ...
	 * @throws ACBrException
	 */
	public native void abreCupom(String cpfCnpj, String nome, String endereco, boolean modoPreVenda) throws ACBrException;
	 ...
	 * @param tipoDescontoAcrescimo Tipo de desconto: "$" para valor ou "%"
	 * para percentual.
	 * @param descontoAcrescimo Desconto ou acréscimo: "D" para desconto ou
	 * "A" para acréscimo.
	 * @param codDepartamento Código do departamento
	 * @throws ACBrException
	 */
	public native void vendeItem(String codigo, String descricao, String aliquotaICMS, double qtd, double valorUnitario, double descontoPorc, String unidade, String tipoDescontoAcrescimo, String descontoAcrescimo, int codDepartamento) throws ACBrException;
	 ...
	 * @throws ACBrException
	 */
	public native void descontoAcrescimoItemAnterior(double valorDescontoAcrescimo, String descontoAcrescimo, String tipoDescontoAcrescimo, int item) throws ACBrException;
	 ...
	 * @param imprimeVinculado Flag indicando se haverá impressão de
	 * comprovante vinculado para este pagamento.
	 * @throws ACBrException
	 */
	 ...
	 *
	 * @param tipoAcrescimoDesconto Desconto ou acréscimo: "D" para desconto
	 * ou "A" para acréscimo.
	 * @throws ACBrException
	 */
	...
	/**
	 * Programa uma nova alíquota na memória do ECF.<br> Cuidado, um
	 * alíquota uma vez programada não pode ser removida da memória do ECF.
	 *
	...
	/**
	 * Programa uma nova forma de pagamento na memória do ECF.<br/> Cuidado,
	 * um forma de pagamento uma vez programada não pode ser removida da
	 * memória do ECF.
	 *
	 * @param descricao Descrição da forma de pagamento.
	 * @param permiteVinculado Flag indicando se a forma de pagamento
	 * permite impressão de cupom vinculado.
	 * @throws ACBrException
	 */
	 ...
	 * Cuidado, um comprovante não fiscal uma vez programada não pode ser
	 * removida da memória do ECF.
	 *
	 * @param descricao
	 * @param tipo
	 * @throws ACBrException
	 ...
	 * @throws ACBrException
	 */
	public native void sangria(double valor, String obs, String descricaoCNF, String descricaoFPG, int indiceBmp) throws ACBrException;
	 ...
	 * @throws ACBrException
	 */
	public native void suprimento(double valor, String obs, String descricaoCNF, String descricaoFPG, int indiceBmp) throws ACBrException;
