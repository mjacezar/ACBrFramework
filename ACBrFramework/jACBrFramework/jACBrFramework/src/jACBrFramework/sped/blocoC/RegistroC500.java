 ...
 * 
 * @author Jose Mauro
 * @version Criado em: 29/01/2014 08:36:11, revisao: $Id$
 */
public class RegistroC500 {
     ...
     * nota fiscal/conta de fornecimento de agua canalizada (codigo 29) e 
     * nota fiscal/conta de fornecimento de gas (codigo 28).
     */
    private Collection<RegistroC510> registroC510 = new ArrayList<RegistroC510>();     
    /**
     * Registro analitico do documento - nota fiscal/conta de energia eletrica (codigo 06),
     * nota fiscal/conta de fornecimento de agua canalizada (codigo 29) e 
     * nota fiscal de consumo de gas (codigo 28).
     */
    private Collection<RegistroC590> registroC590 = new ArrayList<RegistroC590>();     
    /**
    ...
    private String SUB;
    /**
     * Codigo de classe de consumo de energia elétrica ou gas.
     */
    ...
    /**
     * Valor total dos serviços nao-tributados pelo ICMS.
     */
     ...
     * nota fiscal/conta de fornecimento de agua canalizada (codigo 29) e
     * nota fiscal/conta de fornecimento de gas (codigo 28).
     * @return the registroC510
     */
    public Collection<RegistroC510> getRegistroC510() {
        return registroC510;
    }
     ...
     */
    public Collection<RegistroC590> getRegistroC590() {
        return registroC590;
    }
    ...
    /**
     * Codigo de tipo de Ligacao.
     * @param TP_LIGACAO the TP_LIGACAO to set
     */
