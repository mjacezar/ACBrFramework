...
public interface ACBrECFInterop extends InteropLib {
	...
	int ECF_GetControlePorta(int ecfHandle);
	...
	int ECF_GetReTentar(int ecfHandle);
	...
	int ECF_SetControlePorta(int ecfHandle, boolean value);
	int ECF_SetDecimaisPreco(int ecfHandle, int value);
	int ECF_SetDecimaisQtd(int ecfHandle, int value);
	int ECF_SetDescricaoGrande(int ecfHandle, boolean value);
	int ECF_SetEAD(int ecfHandle, int eadHandle);
	int ECF_SetGavetaSinalInvertido(int ecfHandle, boolean value);
	...
	int ECF_SetLinhasEntreCupons(int ecfHandle, int value);
	...
	int ECF_SetOperador(int ecfHandle, String value);
	int ECF_SetPaginaDeCodigo(int ecfHandle, int pagina);
	int ECF_SetPausaRelatorio(int ecfHandle, int value);
	int ECF_SetReTentar(int ecfHandle, boolean value);
