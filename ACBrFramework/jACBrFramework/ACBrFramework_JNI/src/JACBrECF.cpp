...
JNIEXPORT void JNICALL Java_jACBrFramework_ACBrECF_programaFormaPagamento(JNIEnv *env, jobject obj, jstring descricao, jboolean permiteVinculado)
{
	INTPTR handle = GetACBrHandle(env, obj);
...
JNIEXPORT void JNICALL Java_jACBrFramework_ACBrECF_programaComprovanteNaoFiscal(JNIEnv *env, jobject obj, jstring descricao, jstring tipo)
{
	INTPTR handle = GetACBrHandle(env, obj);
