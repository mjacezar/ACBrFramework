...
{
	public class ACBrTEFDResp : ACBrComposedComponent
	{
		#region Constructor

		internal ACBrTEFDResp(ACBrTEFD parent) : base(parent) { }
		...
		public ACBrTEFDTipo TipoGP
		{
			get
			{
				return (ACBrTEFDTipo)GetInt32(ACBrTEFInterop.TEF_Resp_GetTipoGP);
			}
		}
