 ...
 * 
 * @author Jose Mauro
 * @version Criado em: 28/01/2014 17:37:09, revisao: $Id$
 */
public class RegistroC320 {
     ...
     * Itens de resumo diario dos documentos (codigo 02).
     */
    private Collection<RegistroC321> registroC321 = new ArrayList<RegistroC321>();     
    /**
    ...
    /**
     * Valor total acumulado das operacoes correspondentes a combinacao de 
     * CST_ICMS, CFOP e aliquota do ICMS, incluidas as despesas acessorias e acrescimos. 
     */
    ...
    /**
     * Valor nao tributado em funcao da reducao da base de caculo do ICMS, 
    ...
    /**
     * Itens de resumo diario dos documentos (codigo 02).
     * @return the registroC321
     */
    public Collection<RegistroC321> getRegistroC321() {
        return registroC321;
    }
