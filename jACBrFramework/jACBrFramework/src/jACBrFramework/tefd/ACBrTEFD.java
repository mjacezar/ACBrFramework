 ...
 *
 * @author Jose Mauro
 * @version Criado em: 27/02/2014 14:57:31, revisao: $Id: ACBrTEFD.java 6436
 * 2014-03-07 12:41:31Z jmsandy $
 */
public class ACBrTEFD extends ACBrClass {
    ...
    private void onInfoECF(int pOperacao, Pointer pRetornoECF, int pRetornoECFLen) {
