 ...
 * 
 * @author Jose Mauro
 * @version Criado em: 28/02/2014 14:15:36, revisao: $Id$
 */
public class TefDial extends ACBrComposedClass {

    //<editor-fold defaultstate="collapsed" desc="Constructor">
    TefDial(ACBrTEFD pParent) throws ACBrException {
        super(pParent);
    }
    // </editor-fold>
    ...
    public void setAutoAtivarGP(boolean pIndAutoAtivarGP) throws ACBrException {
        int ret = ACBrTEFInterop.INSTANCE.TEF_TEFDial_SetAutoAtivarGP(getHandle(), pIndAutoAtivarGP);
        checkResult(ret);
    }
    ...
    public boolean isAutoAtivarGP() throws ACBrException {
        int ret = ACBrTEFInterop.INSTANCE.TEF_TEFDial_GetAutoAtivarGP(getHandle());
        checkResult(ret);
        return ret == 1;
    }      
    ...
    public void setNumVias(int pNumVias) throws ACBrException {
        int ret = ACBrTEFInterop.INSTANCE.TEF_TEFDial_SetNumVias(getHandle(), pNumVias);
        checkResult(ret);
    }
    ...
    public int getNumVias() throws ACBrException {
        int ret = ACBrTEFInterop.INSTANCE.TEF_TEFDial_GetNumVias(getHandle());
        checkResult(ret);
        return ret;
    }         
    ...
    public void setEsperaSTS(int pEsperaSTS) throws ACBrException {
        int ret = ACBrTEFInterop.INSTANCE.TEF_TEFDial_SetEsperaSTS(getHandle(), pEsperaSTS);
        checkResult(ret);
    }
    ...
    public int getEsperaSTS() throws ACBrException {
        int ret = ACBrTEFInterop.INSTANCE.TEF_TEFDial_GetEsperaSTS(getHandle());
        checkResult(ret);
        return ret;
    }    
    ...
    public void setArqTemp(String pArqTemp) throws ACBrException {
        int ret = ACBrTEFInterop.INSTANCE.TEF_TEFDial_SetArqTemp(getHandle(), toUTF8(pArqTemp));
        checkResult(ret);
    }
    ...
    public String getArqTemp() throws ACBrException {
        ...
        int ret = ACBrTEFInterop.INSTANCE.TEF_TEFDial_GetArqTemp(getHandle(), lArqTemp, STR_BUFFER_LEN);
        checkResult(ret);   
    ...
    public void setArqReq(String pArqReq) throws ACBrException {
        int ret = ACBrTEFInterop.INSTANCE.TEF_TEFDial_SetArqReq(getHandle(), toUTF8(pArqReq));
        checkResult(ret);
    }
    ...
    public String getArqReq() throws ACBrException {
        ...
        int ret = ACBrTEFInterop.INSTANCE.TEF_TEFDial_GetArqReq(getHandle(), lArqReq, STR_BUFFER_LEN);
        checkResult(ret);   
    ...
    public void setArqSTS(String pArqSTS) throws ACBrException {
        int ret = ACBrTEFInterop.INSTANCE.TEF_TEFDial_SetArqSTS(getHandle(), toUTF8(pArqSTS));
        checkResult(ret);
    }
    ...
    public String getArqSTS() throws ACBrException {
        ...
        int ret = ACBrTEFInterop.INSTANCE.TEF_TEFDial_GetArqSTS(getHandle(), lArqSTS, STR_BUFFER_LEN);
        checkResult(ret);   
    ...
    public void setGPExeName(String pGPExeName) throws ACBrException {
        int ret = ACBrTEFInterop.INSTANCE.TEF_TEFDial_SetGPExeName(getHandle(), toUTF8(pGPExeName));
        checkResult(ret);
    }
    ...
    public String getGPExeName() throws ACBrException {
        ...
        int ret = ACBrTEFInterop.INSTANCE.TEF_TEFDial_GetGPExeName(getHandle(), lGPExeName, STR_BUFFER_LEN);
        checkResult(ret);   
    ...
    public void setName(String pName) throws ACBrException {
        int ret = ACBrTEFInterop.INSTANCE.TEF_TEFDial_SetName(getHandle(), toUTF8(pName));
        checkResult(ret);
    }
    ...
    public String getName() throws ACBrException {
        ...
        int ret = ACBrTEFInterop.INSTANCE.TEF_TEFDial_GetName(getHandle(), lName, STR_BUFFER_LEN);
        checkResult(ret);   
    ...
    public void setHabilitado(boolean pHabilitado) throws ACBrException {
        int ret = ACBrTEFInterop.INSTANCE.TEF_TEFDial_SetHabilitado(getHandle(), pHabilitado);
        checkResult(ret);
    }
    ...
    public boolean isHabilitado() throws ACBrException {
        int ret = ACBrTEFInterop.INSTANCE.TEF_TEFDial_GetHabilitado(getHandle());
        checkResult(ret);
        return ret == 1;
    }    
    // </editor-fold>
