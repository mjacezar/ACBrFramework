...
public class Program {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        try {
            ...
            ecf.addOnBobinaAdicionaLinhas(new ACBrEventListener<BobinaAdicionaLinhasEventObject>() {
                @Override
                public void notification(BobinaAdicionaLinhasEventObject e) {
                    System.out.println(">> OnBobinaAdicionaLinhas << Operacao: " + e.getOperacao() + " Linhas: " + e.getLinhas());
                }
            });
