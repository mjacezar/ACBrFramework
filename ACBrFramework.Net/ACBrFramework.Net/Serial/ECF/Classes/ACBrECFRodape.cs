...
{
    public sealed class ACBrECFRodape : ACBrComposedComponent
    {
        internal ACBrECFRodape(ACBrECF acbrECF)
            : base(acbrECF)
        {
            this.NotaLegalDF = new ACBrECFRodapeNotaLegalDF(this);
        }
        ...
        public ACBrECFRodapeNotaLegalDF NotaLegalDF { get; private set; }
    }
}